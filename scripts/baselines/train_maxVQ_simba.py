...
@hydra.main(config_path="../../config", config_name="baselines_configs/maxVQ/cheetah/maxVQ_cheetah", version_base=None)
def train_VQ_simba(cfg: DictConfig):
    ...
    # Oracles (actors + estimator heads, Simba checkpoints)
    ...
    oracles_actors, oracles_critics_all, oracles_values_all = build_simba_oracle_modules_from_cfg(
        cfg=cfg,
        obs_shape=obs_shape,
        act_dim=act_dim,
        device=device,
    ...
    # Train
    print(f"Starting training (VQ Simba mode={selection_mode})...")
