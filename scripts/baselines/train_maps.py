...
@hydra.main(config_path="../../config", config_name="baselines_configs/maps/quad/maps_quad", version_base=None)
def train_maps(cfg: DictConfig):
    ...
    oracles_actors, _, oracles_values = build_oracle_modules_from_cfg(
        cfg=cfg,
        obs_shape=obs_shape,
        act_dim=act_dim,
        device=device,
