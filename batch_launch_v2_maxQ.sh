...
for task in "${tasks[@]}"; do
    EXTRA_ARGS=(method_name=maxQ training.selection_mode=max_q "training.total_timesteps=${TOTAL_TIMESTEPS}" "training.capacity=${CAPACITY}")
